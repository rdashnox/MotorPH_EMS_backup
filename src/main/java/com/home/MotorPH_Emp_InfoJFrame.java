...
public class MotorPH_Emp_InfoJFrame extends javax.swing.JFrame {
 

    /**
     * Creates new form MotorPH_Emp_InfoJFrame
     */
    public MotorPH_Emp_InfoJFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        emp_details.setBackground(new java.awt.Color(102, 102, 102));
        emp_details.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        jPanel1.add(emp_details, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 140, 380, 50));
        ...
        emp_table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EID", "Last Name", "First Name", "Birthday"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 210, 720, 450));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       this.hide();
        MotorPH_AddEmpFrame addObj = new MotorPH_AddEmpFrame();
        addObj.show();
    ...
    private void emp_detailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_emp_detailsActionPerformed
        ...
        Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/motorphemployees", "root", "mYSQLDASH/4*");

        // Create a statement
        Statement statement = connection.createStatement();

        // Execute a query to select Employee #, Last Name, First Name, Birthday
        ResultSet resultSet = statement.executeQuery("SELECT `EID`, `Last Name`, `First Name`, Birthday FROM emp_msdb");
        ...
        while (resultSet.next()) {
            ...
            model.addRow(new Object[]{EID, lastName, firstName, birthday});
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MotorPH_Emp_InfoJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MotorPH_Emp_InfoJFrame().setVisible(true);
            }
        });
    }
