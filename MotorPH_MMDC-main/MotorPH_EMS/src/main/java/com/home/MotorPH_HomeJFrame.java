...
public class MotorPH_HomeJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        emp_info = new javax.swing.JButton();
        ...
        emp_info.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        emp_info.setText("Employee Information");
        emp_info.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                emp_infoActionPerformed(evt);
            }
        });
        jPanel1.add(emp_info, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 100, 260, 40));
    ...
    private void emp_infoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_emp_infoActionPerformed
        this.hide();
        MotorPH_Emp_InfoJFrame empObj = new MotorPH_Emp_InfoJFrame();
        empObj.show();
        
    }//GEN-LAST:event_emp_infoActionPerformed
    ...
    private javax.swing.JButton emp_info;
